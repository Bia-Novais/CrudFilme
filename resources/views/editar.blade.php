            ...
            <form method="POST" action="/atualizar/{{$filmes->id}}" enctype="multipart/form-data">
                ...
                <div class="md:flex items-center mt-12">
                    <div class="w-full md:w-1/2 flex flex-col">
                        ...
                        <textarea type="text" name="resumo" value="{{$filmes->resumo}}" placeholder="Resumo" class="leading-none text-gray-900 p-3 focus:outline-none focus:border-blue-700 mt-4 bg-gray-100 border rounded border-gray-200"></textarea>
                    </div>
                    <div class="w-full md:w-1/2 flex flex-col md:ml-6 md:mt-0">
